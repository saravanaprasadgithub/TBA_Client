...
import 'package:first_app/Social_Media_Management/social_media_form.dart';
      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              leading: Icon(Icons.qr_code_outlined,color: Colors.white,), title: Text("Social Media Form",style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.w500),),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const social_media_form()),);
              },
            ),
            Divider(
              color: Colors.white,
