...
class SEOon_form extends StatefulWidget {
  const SEOon_form({Key? key}) : super(key: key);

  @override
  State<SEOon_form> createState() => _SEOon_formState();
}

class _SEOon_formState extends State<SEOon_form> {
                    ...
                    onPressed: ()async{
                      if(_formkey.currentState!.validate())
                      {
                        try{
                          ...
                          if(task!=null){
                            firestoreInstance.collection("SEOon Form").doc(userid!.email).set(
                                {
  ...
  getdata()async{
    final data =firestoreInstance.collection("SEOon Form").doc(userid!.email);
  ...
  Future uploadFile() async {
    ...
    final path = 'SEOon Form/${userid!.email}/${pickedFile!.name}';
