...
import 'package:first_app/OnPage_Seo/seoOn_form.dart';
import 'package:first_app/landing_page.dart';
import 'package:flutter/material.dart';

class SEOon_Menu extends StatefulWidget {
  const SEOon_Menu({Key? key}) : super(key: key);
  @override
  State<SEOon_Menu> createState() => _SEOon_MenuState();
}

class _SEOon_MenuState extends State<SEOon_Menu> {
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('SEO-On Service Requirements',style: TextStyle(fontSize: 20),),
          centerTitle: true,
          actions: [
            IconButton(
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SEOon_form()),);
                },
              ),
              Divider(
                color: Colors.white,
