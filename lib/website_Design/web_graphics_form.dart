...
class _design_graphicsformState extends State<design_graphicsform> {
  ...
  Future uploadFile() async {
    ...
    final path = 'Website Design Graphics/${userid!.email}/${pickedFile!.name}';
  ...
  Future uploadFile1() async {
    ...
    final path = 'Website Design Graphics/${userid!.email}/${pickedFile1!.name}';
    final ref = FirebaseStorage.instance.ref().child(path);
    setState(() {
      task=ref.putFile(file);
    });
  ...
  Future uploadFile2() async {
    ...
    final path = 'Website Design Graphics/${userid!.email}/${pickedFile2!.name}';
    final ref = FirebaseStorage.instance.ref().child(path);
    setState(() {
      task=ref.putFile(file);
    });
  ...
  Future uploadFile3() async {
    ...
    final path = 'Website Design Graphics/${userid!.email}/${pickedFile3!.name}';
    final ref = FirebaseStorage.instance.ref().child(path);
    setState(() {
      task=ref.putFile(file);
    });
  ...
  Future uploadFile4() async {
    ...
    final path = 'Website Design Graphics/${userid!.email}/${pickedFile4!.name}';
    final ref = FirebaseStorage.instance.ref().child(path);
    setState(() {
      task=ref.putFile(file);
    });
