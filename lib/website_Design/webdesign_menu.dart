...
import 'package:first_app/website_Design/web_content_form.dart';
import 'package:first_app/website_Design/web_graphics_form.dart';
import 'package:first_app/website_Design/web_technical_form.dart';
import 'package:flutter/material.dart';

class Web_Design extends StatefulWidget {
  const Web_Design({Key? key}) : super(key: key);
  @override
  State<Web_Design> createState() => _Web_DesignState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Website Design Development',style: TextStyle(fontSize: 20),),
        centerTitle: true,
        actions: [
          IconButton(
          ...
          SizedBox(
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const design_technicalform()),);
                },
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const design_graphicsform()),);
                },
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const design_Contentform()),);
                },
