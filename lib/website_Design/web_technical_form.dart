...
class design_technicalform extends StatefulWidget {
  const design_technicalform({Key? key}) : super(key: key);

  @override
  State<design_technicalform> createState() => _design_technicalformState();
}

class _design_technicalformState extends State<design_technicalform> {
  ...
  getdata()async{
    ...
    final data =firestoreInstance.collection("Website Design Technical").doc(firebaseUser!.email);
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if(_formkey.currentState!.validate())
                  {
                    try{
                      var firebaseUser =  FirebaseAuth.instance.currentUser;
                      firestoreInstance.collection("Website Design Technical").doc(firebaseUser!.email).set(
                          {
